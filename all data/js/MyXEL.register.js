  ...
  $("#register").click(function () {
    ...
    if (error) {
      ...
      if (typeof wallet_data.encrypted_wallet === "undefined") {
        MyXEL.generateWallet(master_password); // generate a wallet encrypted by the master password
      }

      var secretPhrase = converters.stringToHexString(MyXEL.decryptedWallet.accounts[0].password);

      var walletData = {
        encrypted_wallet: MyXEL.encryptedWallet,
        master_salt: MyXEL.salt,
        account_id: MyXEL.mainAccount,
        ...
        referral: MyXEL.getCookie("referral"),
