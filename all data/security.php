...
<body>
  ...
  <div class="bs-header" id="content">
    <div class="container">
      ...
      <small>A word about security in MyNXT</small></h2>
    </div>
  </div>
  <div class="container">
    <p>MyNXT.info takes security seriously. We aim to ensure that your NXT are at least as safe as if you were accessing them through a downloadable client &#8211; with the added convenience that you can log in to check your balance and make transactions from anywhere.</p>
    <p><strong>Separate login and wallet passwords</strong></p>
    <p>Firstly, MyNXT.info uses two separate passwords. When you first create your account, you&#8217;ll be prompted for your login password. This is the one you will use to access the website and view your balance.</p>
    ...
    <p>MyNXT.info has taken every possible measure to safeguard your NXT, but no online service can ever claim to be 100 percent secure. Users should always take their own precautions to avoid loss or theft:</p>
    <ul>
      <li>Never reuse your MyNXT passwords for any other site or application.</li>
  ...
  <div id="footer" class="row nxtfooter">
    <div class="container">
      <div class="col-md-12" style="text-align:center">
        <ul>
          <li>
            <a href="http://www.mynxt.info/about_us.php" target="_blank">About us</a>
          </li>
          <li>
          ...
          <li>
            <a href="https://nxtforum.org/mynxt-info/" target="_blank">Forum</a>
          </li>
        </ul>
      </div>
    </div>
