...
<head>
  ...
  <base href="/">
  <title>MyXEL - NXT Online Wallet Evolved</title>
...
<body>
          ...
          <div class="navbar navbar-default hidden-sm hidden-xs" role="navigation">
            <div>
              <ul class="nav navbar-nav">
                ...
                <li>
                  <a href="https://www.MyXEL.info">Block Explorer</a>
                </li>
              </ul>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-offset-2 col-sm-8">
          ...
          <p class="h45 tac">MyXEL.info gives you the security of a downloadable client with the convenience of a web wallet. Users own their wallets, but do not have to download the blockchain or any other software! At no point does MyXEL have access to your funds.</p><br>
          <br>
          <div class="row" id="hiw">
            <div class="row">
              <div class="col-sm-4">
                ...
                <p class="h45 htext">When you register, you'll create a login password. You will use this password for logging into MyXEL.info</p>
              </div>
              <div class="col-sm-4">
                <img src="images/h2.png" class="img-responsive" alt=""><br>
                <p class="h45 htitle">CREATE A WALLET</p>
                <p class="h45 htext">You will also create a master password which is used to encrypt and decrypt your wallet. MyXEL.info never receives this password.</p>
              </div>
              <div class="col-sm-4">
                <img src="images/h3.png" class="img-responsive" alt=""><br>
                <p class="h45 htitle">BROWSER ENCRYPTION</p>
                <p class="h45 htext">Your wallet is encrypted and decrypted client-side - that is in your browser - using your master password. MyXEL.info...</p>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-4">
              ...
              <div class="col-sm-4">
                ...
                YOUR WALLET</p>
                <p class="h45 htext">Users have full ownership of their wallets. MyXEL.info is simply a gateway to NXT. You can download backups of your...</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row" id="downloaddetails">
        <div class="col-sm-offset-1 col-sm-10">
          <div class="col-sm-6">
            ...
            <p class="h45 downloaddesc">Access your MyXEL funds securely with our mobile app available for Android and iPhone. Check your balance and send/receive funds quicly and easily with the tap of a finger.</p><br>
            <div class="row" id="downloadlink">
              <div class="col-sm-4">
                <br>
                <a href="https://play.google.com/store/apps/details?id=info.MyXEL.mobile_wallet" target="_blank"><img src="images/playstore.png" class="img-responsive" alt=""></a>
              </div>
              <div class="col-sm-4">
                <br>
                <a href="https://itunes.apple.com/app/MyXEL-wallet/id917423860" target="_blank"><img src="images/appstore.png" class="img-responsive" alt=""></a>
              </div>
      ...
      <div class="col-sm-offset-1 col-sm-10">
        ...
        <div class="row" id="someplugins">
          ...
          <div class="col-sm-3">
            ...
            <hr class="phr">
            <p class="h55 pdesc">Use the official NXT Full Client (a.k.a. NRS) drectly from your MyXEL Wallet.<br></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row" id="questions">
    <div class="container">
      ...
      <p class="h45">We run a forum in the nxtforum.org website, where you can ask any question and interact with other MyXEL.info users. Please come and say hi to us!</p><br>
      <form action="https://nxtforum.org/MyXEL-info/" target="_blank">
        <input type="submit" class="forumbutton h45" value="Go to The Forum">
      </form><br>
      <p class="h45" style="font-size: 18px">Need a direct line? Email us at MyXEL@supernet.org</p><br>
      <a href="https://github.com/MyXEL-info/wallet" class="h45 replink" target="_blank">Visit our public repository</a><br>
      <br>
      <br>
      <br>
  ...
  <div class="row" id="clients">
    <div class="container">
      <div class="col-sm-offset-2 col-sm-8">
        ...
        <p class="h45">These are some of the recent articles mentioning MyXEL. If you are a member of the press and would like to contact us, please email MyXEL@supernet.org.<br>
        <br></p>
        <div class="row">
          <div>
      ...
      <div class="col-sm-offset-1 col-sm-10">
        <div class="col-sm-4">
          ...
          <div class="col-sm-6" style="padding-left: 0;">
            <a href="https://www.MyXEL.info" class="flinks h45">Block Explorer</a><br>
            <a href="http://www.MyXEL.info/charts/" class="flinks h45">Charts</a><br>
          </div>
          <div class="col-sm-6" style="padding-left: 0;">
            <a href="https://www.MyXEL.info/about_us.php" class="flinks h45">About us</a><br>
            <a href="/docs" class="flinks h45">Developers</a><br>
            <a href="/faq.php" class="flinks h45">F.A.Q.</a><br>
            <a href="https://nxtforum.org/MyXEL-info/" class="flinks h45">Forum</a><br>
          </div>
        </div>
        <div class="col-sm-3">
          ...
          <div class="row">
            ...
            <div class="col-xs-10">
              <p class="h45 ftext" style="line-height: 1.5em;">MyXEL by Evolufy Ltd<br>
              Made in the UK</p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-xs-10">
              <p class="h45 ftext">MyXEL@supernet.org</p>
            </div>
          </div>
        </div>
        <div class="col-sm-5">
          ...
          <div class="row">
            <form action="//www.MyXEL.info/sendy/subscribe" method="post" accept-charset="utf-8" target="_blank">
